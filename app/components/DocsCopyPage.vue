...
type PageItem = ContentCollectionItem & {
  rawbody?: string;
};
  ...
  <Popover>
    ...
    >
      ...
      <Separator
        ...
        class="absolute top-0 right-8 z-0 h-8! bg-foreground/10! peer-focus-visible:opacity-0 sm:right-7 sm:h-7!"
      />
