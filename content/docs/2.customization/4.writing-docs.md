...
- **`new`**: (Optional) Set to `true` to display a **"New"** badge next to the page title in the sidebar.

### "New" Badge

To mark a page as new, simply add `new: true` to its frontmatter:

```yaml
---
title: My New Page
description: This page was just added.
new: true
---
```

A small badge will appear next to the page title in the sidebar navigation. Remove the line (or set `new: false`) when the page is no longer new.
